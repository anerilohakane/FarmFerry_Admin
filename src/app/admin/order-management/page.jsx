...
//                   <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden xl:table-cell">Delivery</th>
...
//                         <span className="hidden xs:inline">{order.status.replace('_', ' ')}</span>
//                       </span>
//                     </td>
...
//                           </div>
//                           <div className="text-xs text-gray-500">{order.deliveryAssociate.associate.phone}</div>
//                         </div>
//                       ) : (
...
//         <div className="p-4 md:p-6 border-b border-gray-200">
//           <div className="flex justify-between items-center">
//             <h3 className="text-lg md:text-xl font-bold text-gray-900">Order Details - {selectedOrder?.orderId}</h3>
//             <button
...
//                 <h4 className="font-semibold text-gray-900 mb-2 md:mb-3 flex items-center gap-2">
...
//                   <p className="break-words"><span className="font-medium">Address:</span> {selectedOrder?.deliveryAddress?.street}, {selectedOrder?.deliveryAddress?.city}, {selectedOrder?.deliveryAddress?.state} {selectedOrder?.deliveryAddress?.postalCode}</p>
//                 </div>
//               </div>
...
//                   <p className="flex items-center gap-1"><span className="font-medium">Status:</span> 
...
//                     <p className="font-bold text-base md:text-lg">{formatCurrency(selectedOrder?.totalAmount)}</p>
//                   </div>
//                 </div>
//               </div>
...
//                       <p className="text-gray-700 bg-white p-2 rounded border text-xs md:text-sm">{selectedOrder.notes}</p>
//                     </div>
//                   )}
//                 </div>
//               </div>
...
//               <p className="text-xs md:text-sm text-gray-600 mb-1">Order ID: <span className="font-medium">{selectedOrder?.orderId}</span></p>
...
//               <p className="text-gray-500 text-sm md:text-base">No delivery associates available</p>
//             ) : (
//               deliveryAssociates.map((associate) => (
//                 <div
//                   key={associate._id}
//                   className={`p-2 md:p-3 rounded-lg border transition-colors text-sm ${
//                     associate.isOnline 
